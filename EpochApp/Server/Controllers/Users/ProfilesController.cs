...
namespace EpochApp.Server.Controllers
{
    ...
    public class ProfilesController : ControllerBase
    {
            ...
            var profData = new ProfileDTO
                           {
                               ...
                               Socials = profile.Socials.Select(s => new SocialDTO() { Social = s.Social, Handle = s.SocialHandle }).ToList()
                           };
        ...
        public async Task<IActionResult> PutProfile(Guid id, ProfileDTO profileData)
        {
            ...
            profile.Socials = profileData.Socials.Select(s => new UserSocial() { Social = s.Social, SocialHandle = s.Handle }).ToList();
